...
let favoriteFoods=['Mexican food', 'Indian food', 'pizza', 'pasta', 'salad'];
...
let entree = 'chips and salsa'
favoriteFoods.unshift(entree)
console.log('favorite entree, foods, and dessert are:', favoriteFoods)
